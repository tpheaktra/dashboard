...
<div class="wrapper">
    <div class="content header">
        ...
        <div class="logo-menu">
            <div class="container">
                <div class="logo">
                    <a href="{{asset('index')}}"><img src="http://placehold.it/863x229" /></a>
                </div>
                <div class="hamburger">
                    <img src="assets/template/images/navicon.svg"/>
                </div>
                <div class="menu">
                    <ul>
                            <li><a href="{{asset('home')}}">home</a></li>
                            <li><a href="{{asset('tours')}}">Tours</a></li>
                            <li><a href="{{asset('gallary')}}">gallery</a></li>
...
<div class="wrapper">
    <div class="content footer">
            ...
            <div class="footer-top">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <ul>
                            <li><span><img src="{{asset('front-end/images/call-footer.png')}}" /></span>085 214 290</li>
                            <li><span><img src="{{asset('front-end/images/sms-infor.png')}}" /></span><a  href="mailto:siemreaptravel@gmail.com" >siemreaptravel@gmail.com</a></li>

                            <li><span><img src="{{asset('front-end/images/time.png')}}" /></span>working Day 8:00AM-12:00PM and 1:00PM-5:00PM</li>
                            <li><span><img src="{{asset('front-end/images/add.png')}}" /></span>Siem Reap, Siem Reap Province, Cambodia </li>
                        </ul>
                    </div>
                    <div class="col-sm-6 col-xs-12">
                        <div class="footer-logo">
                            <a href="index.html"><img src="http://placehold.it/863x229" /></a>
                        </div>
                        <p>
                          We take care of our clients and make advance booking and transportation to the hotel.
                        </p>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="pull-left developed"><span>&copy; 2017 siemreaptravel. All Rights Reserved. </span></div>
                <div class="pull-right developed"><span>Developed by Student RUPP</span></div>
            </div>
        </div>
